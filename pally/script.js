...
recordButton.addEventListener("click", async () => {
  if (!recognition) {
    ...
    recognition.onresult = async (event) => {
      ...
      resultDiv.innerHTML = `<br><div style="display: flex; align-items: center; justify-content: right;"><div style=" border-radius: 50%; height: 45px; width: 45px; padding: 5px; display:flex; justify-content: center; border: 2px solid red; margin-right: 5px;"> <img src="images/avatar.jpg" alt="User Icon" style="width: 30px; height: 30px; border-radius 50%:;"> </div> ${recognizedText} </div>`;
