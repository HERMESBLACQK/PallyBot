...
recordButton.addEventListener("click", async () => {
  if (!recognition) {
    ...
    recognition.onresult = async (event) => {
      ...
      resultDiv.innerHTML = `<br> ${recognizedText}  <div style="border: 1px solid #eaa5ea; border-radius: 50%; height: 40px; width: 40px; margin-right:  5px; display:flex; justify-content: center; "> <img src="images/avatar.jpg" alt="User Icon" style="width: 30px; height: 30px;"> </div>`;
