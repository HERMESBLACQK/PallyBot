...
recordButton.addEventListener("click", async () => {
  if (!recognition) {
    ...
    recognition.onresult = async (event) => {
      ...
      resultDiv.innerHTML = `<br><div style="display: flex; align-items: center; justify-content: right;><div style="border: 1px solid #eaa5ea; border-radius: 50%; height: 40px; width: 40px;display:flex; justify-content: center; border: 2px solid red;"> <img src="images/avatar.jpg" alt="User Icon" style="width: 30px; height: 30px;"> </div> ${recognizedText} </div>`;
