  ...
  if (!recognition) {
    ...
    recognition.onresult = async (event) => {
      ...
      sendTranslatedTextToGpt(recognizedText).then(gptRes => {
        botDiv.innerHTML += `<br> <div style="display: flex; align-items: center; border: 2px solid red; padding: 5px;"> <img src="images/favicon.png" alt="Pally Icon" style="width: 20px; height: 20px; margin-right: 5px;"> ${gptRes}</div>`
